...
import { MessageCircle, X, Send, Image as ImageIcon, Loader2, Check, CheckCheck, Reply, Smile, Mic, Paperclip } from 'lucide-react';
import {
  getSessionId,
  initializeSession,
  sendMessage,
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 ${
          isOpen
            ...
            : 'bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 hover:scale-110 hover:shadow-purple-500/50'
        }`}
      >
        {isOpen ? (
                      ...
                      >
                        <div className="max-w-[85%]">
                          ...
                          <div
                            ...
                            } ${msg.replyTo ? 'rounded-tl-md rounded-tr-md' : ''}`}
                          >
                            {/* Reply Button */}
                            <button
